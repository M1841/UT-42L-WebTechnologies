export const ro = {
  header: {
    links: [
      { path: "index.html", name: "Acasă" },
      { path: "team.html", name: "Echipă" },
      { path: "publications.html", name: "Publicații" },
    ],
  },
  footer: {
    items: [
      {
        title: "Sisteme Sigure",
        paragraphs: [
          "Universitatea Tehnică din Cluj-Napoca",
          "Facultatea de Automatică și Calculatoare",
          "Departamentul de Automatizări",
        ],
      },
      {
        title: "Contact",
        paragraphs: ["Telefon: +40 264 401427", "Fax: +40 264 594835"],
      },
      {
        title: "Adresă",
        paragraphs: ["Str. G. Barițiu 26-28, 400027, Cluj-Napoca, România"],
      },
      {
        title: "Director",
        paragraphs: [
    ...
    areas: [
      {
        ...
        paragraphs: [
          ...
          "Analiza, proiectarea, implementarea și testarea sistemelor informaționale cu proprietăți de siguranță utilizate în diverse domenii (de exemplu, infrastructuri critice - energie, apă, mediu, transport; medicină)",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Dezvoltarea bazelor semantice pentru compunerea modelelor eterogene și pentru limbaje de modelare care descriu diverse procese fizice ale unui CPS și logica asociată acestora",
        ],
      },
      {
  ...
  offer: {
    issues: [
      {
        title: "Cercetare & dezvoltare",
        paragraphs: [
          "Definirea abstractizărilor, proiectarea arhitecturilor și implementarea instrumentelor pentru realizarea CPS-urilor sigure și securizate",
          "Extinderea tehnicilor de inteligență artificială pentru implementarea aplicațiilor de modelare și control",
      ...
      },
      {
        ...
        paragraphs: [
          "Servicii de testare asistată de calculator",
      ...
      },
      {
        ...
        paragraphs: [
          "Bazele CPS: arhitectură hardware și software, dezvoltarea și programarea dispozitivelor fizice, suport decizional, proiectarea și gestionarea bazelor de date istorice, pre- și post-procesarea datelor istorice",
