  ...
  template: /* html */ `
    <section class="team-member-cards" v-if="members">
      ...
      <div class="members-list">
        <div class="member-card" :class="{ 'professor-only': type === 'professors' }" v-for="member in members" :key="member.name.first + member.name.last">
          ...
          <div class="member-info">
            ...
            <div class="disciplines" v-if="member.disciplines">
              <span class="discipline-tag" v-for="discipline in member.disciplines" :key="discipline">{{ discipline }}</span>
            </div>
